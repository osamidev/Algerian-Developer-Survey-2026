    ...
    <div className="bg-background-main flex min-h-screen items-center justify-center text-white">
      <div className="bg-background-surface/30 z-10 w-full max-w-2xl rounded-2xl p-8 text-center backdrop-blur">
        ...
        <div className="flex items-center justify-center gap-4">
          <button
            onClick={onRetry}
            className="bg-brand-primary hover:bg-brand-hover cursor-pointer rounded-xl px-6 py-3 font-mono font-semibold text-white"
          >
            Retry
          </button>
          <Link
            to="/"
            className="bg-background-surface/20 rounded-xl border border-white/10 px-6 py-3 font-mono font-medium text-white/90"
          >
            Go Home
          </Link>
        </div>
